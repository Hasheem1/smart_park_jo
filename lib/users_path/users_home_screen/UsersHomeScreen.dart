...
//   ];
//
//   int _selectedIndex = 0; // ✅ track current tab
//
//   void _onItemTapped(int index) {
//     // Optional but recommended: prevent action if the user re-taps the active item.
//     // This check is only for state-swapping tabs, not for navigation pushes.
//     // if (index == _selectedIndex) return;
//
//     switch (index) {
//       case 0: // For the main screen
//       // If you are already on the main screen, you might want to pop all other routes
//       // until you are back home. Or just set the state.
//         setState(() {
//           _selectedIndex = index;
//         });
//         break;
//
//       case 1: // For the bookings screen
//         Navigator.push(
//           context,
...
//           IconButton(
//             icon:
//             Icon(Icons.notifications_none_rounded, color: Colors.grey.shade700),
//             onPressed: () {},
//           ),
...
// Search
    ...
    // 🔥 Stream parking lots from Firestore
    StreamBuilder(
