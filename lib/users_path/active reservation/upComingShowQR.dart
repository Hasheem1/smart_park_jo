...
class ActiveReservationScreenUpcoming extends StatefulWidget {
  final String reservationId;

  const ActiveReservationScreenUpcoming({
    super.key,
...
class _ActiveReservationScreenState extends State<ActiveReservationScreenUpcoming> {
